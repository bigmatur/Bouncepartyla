-- 098_harden_my_staff_time_rpc.sql
-- Harden self-service Working Time SECURITY DEFINER RPCs.
-- Keeps current behavior for real staff / active linked drivers and rejects customer-only accounts.
